...
// Function to close the weather modal
const toggleWeatherButton = document.getElementById('toggle-weather-button');
if (toggleWeatherButton) {
    toggleWeatherButton.addEventListener('click', closeWeatherModal);
}
...
// Add event listeners to the weather spans
document.getElementById('cond_txt').addEventListener('click', () => {
    console.log('clicked');
    openWeatherModal();
});
